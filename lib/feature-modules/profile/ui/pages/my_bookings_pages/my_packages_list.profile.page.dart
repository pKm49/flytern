...
class ProfilePackageBookingsList extends StatefulWidget {
  ...
  @override
  State<ProfilePackageBookingsList> createState() =>
      _ProfilePackageBookingsListState();
}

class _ProfilePackageBookingsListState
    extends State<ProfilePackageBookingsList> {
  ...
  Widget build(BuildContext context) {
    ...
    return profileController.myPackageBookingResponse.isNotEmpty
        ? ListView.builder(
            ...
            itemBuilder: (context, index) => Container(
                  ...
                  margin: flyternLargePaddingAll.copyWith(
                      bottom: index ==
                              profileController
                                      .myPackageBookingResponse.length -
                                  1
                          ? flyternSpaceLarge
                          : 0),
